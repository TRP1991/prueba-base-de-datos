...
prueba=# SELECT * FROM productos;
 id | nombre_producto |       descripcion_producto       | valor_unitario | id_categoria 
----+-----------------+----------------------------------+----------------+--------------
 10 | Placa           | Placa Copo de Nieve              |           1000 |             
 20 | Árbol           | Árbol festivo de sobremesa       |            500 |             
 30 | Bolso           | Bolso copo de nieve              |            300 |             
 40 | Lámpara         | Lámpara frutos del bosque        |            600 |             
 50 | Muñeco          | Muñeco equilibrista              |            750 |             
 60 | Conífera        | Conífera bonsai con agua y hojas |           1500 |             
 70 | Set de luces    | Set de nieve de luces            |            450 |             
 80 | Ornamento       | Ornamento brote de bambú         |           1200 |             
(8 rows)
...
prueba=# SELECT DISTINCT nombre_cliente FROM clientes JOIN facturas ON clientes.id=facturas.id_cliente WHERE facturas.precio_total>2000; 
